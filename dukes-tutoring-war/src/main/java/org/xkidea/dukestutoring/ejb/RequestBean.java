    ...
    public String checkIn(Student student) {
        ...
        if (student == null) {
            ...
            if (!students.contains(student)) {
                ...
                System.out.println("--- 3 ----- sessions = " + sessions.toString());
                ...
                System.out.println("--- 5 ----- sessions = " + sessions.toString());
            }
            // set the status
            ...
            System.out.println("--- 6 ----- tutoringSession" + tutoringSession.getStudents().toString());
